...
//const publicRoot = `/home/SandboxALE-AAPP_2019/client/dist` // ON LINUX

// const key = imports.fs.readFileSync('~/selfsigned.key')
// const cert = imports.fs.readFileSync('~/selfsigned-crt')
// const options = {
//   key: key,
//   cert: cert
// }
...
sequelize.sync() // sync sequelize with the server {force : true} = deleting all data
  ...
  .then(() => {
    ...
    // app.server.listen(imports.config.portHttps)
